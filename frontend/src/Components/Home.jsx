...
function Home({user, setUser}) {
  ...
  const handleJustifyClick = (value) => {
   ...
   const handleSignUp = async (eventClick) => {
    ...
    let response = await axios.post('sign_up/', { 'email': email, 'password':password, 'first_name': first_name, 'last_name': last_name})
  ...
  const handleSignIn = async (eventClick) => {
    ...
    let response = await axios.post('sign_in/', { 'email': email, 'password': password})
    console.log(response.data)
    ...
    <MDBContainer className="p-3 my-5 d-flex flex-column w-50">
      ...
      <MDBTabsContent>
        ...
        <MDBTabsPane show={justifyActive === 'tab1'}>
          ...
          <MDBBtn onClick={handleSignIn} className="mb-4 w-100">Sign in</MDBBtn>
        ...
        <MDBTabsPane show={justifyActive === 'tab2'}>
          ...
          <MDBInput wrapperClass='mb-4' label='First Name' id='form3' type='text'/>
          <MDBInput wrapperClass='mb-4' label='Last Name' id='form4' type='text'/>
